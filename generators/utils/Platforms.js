...
var Platforms = (function (_Base) {
  _inherits(Platforms, _Base);
  ...
  function Platforms() {
    ...
    _get(Object.getPrototypeOf(Platforms.prototype), 'constructor', this).apply(this, args);
  ...
  _createClass(Platforms, [{
    ...
    value: function addPlatforms() {
      ...
      if (choices.length) {
        choices.forEach(function (platform) {
